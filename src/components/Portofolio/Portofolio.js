        ...
        projects: [
            {
                ...
                images: [require('../../assets/diabeteslogs1.png'), require('../../assets/diabeteslogs2.png'),
            ...
            },
            {
                ...
                images: [require('../../assets/brewery1.png'), require('../../assets/brewery2.png'),
            ...
            },
            {
                ...
                images: [require('../../assets/submaster1.png'), require('../../assets/submaster2.png'),
            ...
            {
                id: 4, name: "B2Boats", about: "Before starting the final project at the Le Wagon coding bootcamp, we were asked to build an AirBnB clone. My group came up with the idea of a website where people can rent a boat. During the course of the project I built most of the back-end of the application, by working with ruby and ruby on rails.", images: [require('../../assets/b2boats1.png'), require('../../assets/b2boats2.png'),
            ...
            },
            {
                ...
                images: [require('../../assets/todolist1.png'), require('../../assets/todolist2.png')],
